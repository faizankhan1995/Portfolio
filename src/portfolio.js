...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs  and some other cool libraries and frameworks."
  ),
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Integration of third party services such as Cloudinary/ Azure / Netlify"
    ),
  ],
  ...
  schools: [
    {
      ...
      desc: "Participated in research and development of multiple project.",
      descBullets: [
  ...
  experience: [
    {
      ...
      desc:
        "Part of Strategic Technology Advancement Team where we work on projects involving latest and cutting edge technologies. I have experience of working on various projects, writing test cases and deploying to production environment following scrum principles. ",
      // descBullets: []
    },
    {
      ...
      desc:
        "Working as a Lead Full Stack software developer. I am responsible for developing frontend dashboards and backedn API's and deploying to production environment.",
    },
    {
      ...
      desc:
        "Developed a web application for managing inventory, distributors, accounts and Reports/Invoice generation. Frontend was developed using React and Redux while Backed API .Net core Web API.",
    },
    {
      role: "Software Engineer (Intern)",
      ...
      desc:
        " Developed a desktop legal diary application for managing documents and legal cases.",
    },
  ],
};
